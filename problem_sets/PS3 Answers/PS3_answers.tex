...
\lstinputlisting[language=R, firstline=1, lastline=23]{PS3_answers.R} 
		\vspace{.5cm}
		
		
		\item Make a scatterplot of the two variables and add the regression line. 	\vspace{1cm}
\lstinputlisting[language=R, firstline=25, lastline=28]{PS3_answers.R} 	
\begin{figure} [H]
	\includegraphics[width=\linewidth]{vote.difflog.jpeg}
\end{figure}		
\vspace{.5cm}
		\item Save the residuals of the model in a separate object.	\vspace{1cm}
\lstinputlisting[language=R, firstline=31, lastline=31]{PS3_answers.R} 	
	\vspace{.5cm}
...
\lstinputlisting[language=R, firstline=35, lastline=57]{PS3_answers.R} 		
\vspace{.5cm}		
		
		\item Make a scatterplot of the two variables and add the regression line. 	\vspace{1cm}
\lstinputlisting[language=R, firstline=60, lastline=61]{PS3_answers.R} 	
\begin{figure} [H]
	\includegraphics[width=\linewidth]{presvote.difflog.jpeg}
\end{figure}
\vspace{.5cm}			
		\item Save the residuals of the model in a separate object.	\vspace{1cm}
\lstinputlisting[language=R, firstline=64, lastline=64]{PS3_answers.R} 		
\vspace{.5cm}	
		\item Write the prediction equation.
...
\noindent We are interested in knowing how the vote share of the presidential candidate of the incumbent's party is associated with the incumbent's electoral success.
	...
	\begin{enumerate}
		\item Run a regression where the outcome variable is \texttt{voteshare} and the explanatory variable is \texttt{presvote}.
			\vspace{1cm}
\lstinputlisting[language=R, firstline=68, lastline=90]{PS3_answers.R} 	
\vspace{.5cm}
		\item Make a scatterplot of the two variables and add the regression line. 
			\vspace{1cm}
\lstinputlisting[language=R, firstline=93, lastline=94]{PS3_answers.R} 
\begin{figure} [H]
	\includegraphics[width=\linewidth]{voteshare.presvote.jpeg}
\end{figure}
\vspace{.5cm}
		\item Write the prediction equation.
...
\lstinputlisting[language=R, firstline=130, lastline=150]{PS3_answers.R} 
\vspace{.5cm}
		\item Make a scatterplot of the two residuals and add the regression line. 	\vspace{1cm}
\lstinputlisting[language=R, firstline=103, lastline=104]{PS3_answers.R} 
\begin{figure} [H]
	\includegraphics[width=\linewidth]{residual.lm.jpeg}
\end{figure}
\vspace{.5cm}
		\item Write the prediction equation.
...
\lstinputlisting[language=R, firstline=109, lastline=127]{PS3_answers.R} 	
